...
def generate_morning_brief() -> str:
    ...
    user = (
        ...
        "4. **Content Actions** — For each agency with notable signals, include "
        "a specific, ready-to-execute content action:\n\n"
        "## Content Actions\n"
        "### [Agency Name]\n"
        "**Post today:** [specific topic derived from overnight intelligence]\n"
        "**Why:** [which competitive signal triggered this — name the competitor and action]\n"
        "**Draft hook:** [write the actual first line of the post, ready to copy]\n"
        "**Format:** [text post / carousel / video / article]\n\n"
        "Include one Content Action per agency that had meaningful signals. "
        "Skip agencies with no actionable intelligence. The draft hook must be "
        "specific and punchy, not generic. It should reference the competitive "
        "signal without naming the competitor directly.\n\n"
        "Keep it under 800 words. Be direct and specific — this is read at 8am "
